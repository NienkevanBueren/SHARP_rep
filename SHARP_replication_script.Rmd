...
setwd(dir = "C:/Users/U143161/Desktop/SHARP/R_Files") ########helllo shachar GITHUB REAL-TIME CODING IS SHIT
...
#View(df_SHARP_aperiodic_pre) # Aperiodic exponent (E/I)
...
```{r Data clearning and preperation, include=FALSE, echo=FALSE}
...
# Extract rows with 'ec_ICAP.set' in the 'Subject' column
...
Masterfile_1B_filteredEEG <- Masterfile_1B_filtered[Masterfile_1B_filtered$PreExclude == 0, ]
#View(Masterfile_1B_filteredEEG)

# Adjust the name of the Subject in eo_dataEEG
#View(eo_dataEEG)
...
df_SHARP_total  <- merge(Masterfile_1B_filteredEEG, eo_dataEEG, by = 'Subject', all.x = TRUE, all.y = FALSE) #if NA in exponent/theta then this subject was excluded in masterfile
#View(df_SHARP_total)
